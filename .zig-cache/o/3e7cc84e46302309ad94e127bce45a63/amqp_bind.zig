...
pub const amqp_method_number_t = u32;
pub const amqp_flags_t = u32;
pub const amqp_channel_t = u16;
pub const struct_amqp_bytes_t_ = extern struct {
    len: usize = @import("std").mem.zeroes(usize),
    bytes: ?*anyopaque = @import("std").mem.zeroes(?*anyopaque),
};
pub const amqp_bytes_t = struct_amqp_bytes_t_;
pub const struct_amqp_decimal_t_ = extern struct {
    decimals: u8 = @import("std").mem.zeroes(u8),
...
pub const struct_amqp_array_t_ = extern struct {
    ...
    entries: [*c]struct_amqp_field_value_t_ = @import("std").mem.zeroes([*c]struct_amqp_field_value_t_),
};
...
pub const struct_amqp_field_value_t_ = extern struct {
    kind: u8 = @import("std").mem.zeroes(u8),
...
pub const struct_amqp_table_entry_t_ = extern struct {
    key: amqp_bytes_t = @import("std").mem.zeroes(amqp_bytes_t),
    value: amqp_field_value_t = @import("std").mem.zeroes(amqp_field_value_t),
};
pub const struct_amqp_table_t_ = extern struct {
    num_entries: c_int = @import("std").mem.zeroes(c_int),
    entries: [*c]struct_amqp_table_entry_t_ = @import("std").mem.zeroes([*c]struct_amqp_table_entry_t_),
};
...
pub const struct_amqp_pool_blocklist_t_ = extern struct {
    num_blocks: c_int = @import("std").mem.zeroes(c_int),
    blocklist: [*c]?*anyopaque = @import("std").mem.zeroes([*c]?*anyopaque),
};
pub const amqp_pool_blocklist_t = struct_amqp_pool_blocklist_t_;
pub const struct_amqp_pool_t_ = extern struct {
    pagesize: usize = @import("std").mem.zeroes(usize),
    pages: amqp_pool_blocklist_t = @import("std").mem.zeroes(amqp_pool_blocklist_t),
    large_blocks: amqp_pool_blocklist_t = @import("std").mem.zeroes(amqp_pool_blocklist_t),
    next_page: c_int = @import("std").mem.zeroes(c_int),
    alloc_block: [*c]u8 = @import("std").mem.zeroes([*c]u8),
    alloc_used: usize = @import("std").mem.zeroes(usize),
};
pub const amqp_pool_t = struct_amqp_pool_t_;
pub const struct_amqp_method_t_ = extern struct {
    id: amqp_method_number_t = @import("std").mem.zeroes(amqp_method_number_t),
    decoded: ?*anyopaque = @import("std").mem.zeroes(?*anyopaque),
};
pub const amqp_method_t = struct_amqp_method_t_;
const struct_unnamed_5 = extern struct {
    class_id: u16 = @import("std").mem.zeroes(u16),
    body_size: u64 = @import("std").mem.zeroes(u64),
    decoded: ?*anyopaque = @import("std").mem.zeroes(?*anyopaque),
    raw: amqp_bytes_t = @import("std").mem.zeroes(amqp_bytes_t),
};
const struct_unnamed_6 = extern struct {
    transport_high: u8 = @import("std").mem.zeroes(u8),
    transport_low: u8 = @import("std").mem.zeroes(u8),
    protocol_version_major: u8 = @import("std").mem.zeroes(u8),
    protocol_version_minor: u8 = @import("std").mem.zeroes(u8),
};
const union_unnamed_4 = extern union {
    method: amqp_method_t,
    properties: struct_unnamed_5,
    body_fragment: amqp_bytes_t,
    protocol_header: struct_unnamed_6,
};
pub const struct_amqp_frame_t_ = extern struct {
    frame_type: u8 = @import("std").mem.zeroes(u8),
    channel: amqp_channel_t = @import("std").mem.zeroes(amqp_channel_t),
    payload: union_unnamed_4 = @import("std").mem.zeroes(union_unnamed_4),
};
...
pub const struct_amqp_rpc_reply_t_ = extern struct {
    reply_type: amqp_response_type_enum = @import("std").mem.zeroes(amqp_response_type_enum),
    reply: amqp_method_t = @import("std").mem.zeroes(amqp_method_t),
    library_error: c_int = @import("std").mem.zeroes(c_int),
};
...
pub const struct_amqp_connection_state_t_ = opaque {};
pub const amqp_connection_state_t = ?*struct_amqp_connection_state_t_;
pub const struct_amqp_socket_t_ = opaque {};
...
pub extern fn amqp_decode_properties(class_id: u16, pool: [*c]amqp_pool_t, encoded: amqp_bytes_t, decoded: [*c]?*anyopaque) c_int;
pub extern fn amqp_encode_method(methodNumber: amqp_method_number_t, decoded: ?*anyopaque, encoded: amqp_bytes_t) c_int;
pub extern fn amqp_encode_properties(class_id: u16, decoded: ?*anyopaque, encoded: amqp_bytes_t) c_int;
pub const struct_amqp_connection_start_t_ = extern struct {
    version_major: u8 = @import("std").mem.zeroes(u8),
    version_minor: u8 = @import("std").mem.zeroes(u8),
    server_properties: amqp_table_t = @import("std").mem.zeroes(amqp_table_t),
    mechanisms: amqp_bytes_t = @import("std").mem.zeroes(amqp_bytes_t),
    locales: amqp_bytes_t = @import("std").mem.zeroes(amqp_bytes_t),
};
...
pub const struct_amqp_connection_start_ok_t_ = extern struct {
    client_properties: amqp_table_t = @import("std").mem.zeroes(amqp_table_t),
    mechanism: amqp_bytes_t = @import("std").mem.zeroes(amqp_bytes_t),
    response: amqp_bytes_t = @import("std").mem.zeroes(amqp_bytes_t),
    locale: amqp_bytes_t = @import("std").mem.zeroes(amqp_bytes_t),
};
...
pub const struct_amqp_connection_secure_t_ = extern struct {
    challenge: amqp_bytes_t = @import("std").mem.zeroes(amqp_bytes_t),
};
...
pub const struct_amqp_connection_tune_t_ = extern struct {
    channel_max: u16 = @import("std").mem.zeroes(u16),
    frame_max: u32 = @import("std").mem.zeroes(u32),
    heartbeat: u16 = @import("std").mem.zeroes(u16),
};
...
pub const struct_amqp_connection_open_t_ = extern struct {
    virtual_host: amqp_bytes_t = @import("std").mem.zeroes(amqp_bytes_t),
    capabilities: amqp_bytes_t = @import("std").mem.zeroes(amqp_bytes_t),
    insist: amqp_boolean_t = @import("std").mem.zeroes(amqp_boolean_t),
};
pub const amqp_connection_open_t = struct_amqp_connection_open_t_;
pub const struct_amqp_connection_open_ok_t_ = extern struct {
    known_hosts: amqp_bytes_t = @import("std").mem.zeroes(amqp_bytes_t),
};
...
pub const struct_amqp_connection_close_t_ = extern struct {
    reply_code: u16 = @import("std").mem.zeroes(u16),
    reply_text: amqp_bytes_t = @import("std").mem.zeroes(amqp_bytes_t),
    class_id: u16 = @import("std").mem.zeroes(u16),
    method_id: u16 = @import("std").mem.zeroes(u16),
};
...
pub const struct_amqp_connection_close_ok_t_ = extern struct {
    dummy: u8 = @import("std").mem.zeroes(u8),
};
...
pub const struct_amqp_connection_blocked_t_ = extern struct {
    reason: amqp_bytes_t = @import("std").mem.zeroes(amqp_bytes_t),
};
...
pub const struct_amqp_connection_update_secret_t_ = extern struct {
    new_secret: amqp_bytes_t = @import("std").mem.zeroes(amqp_bytes_t),
    reason: amqp_bytes_t = @import("std").mem.zeroes(amqp_bytes_t),
};
...
pub const struct_amqp_channel_open_t_ = extern struct {
    out_of_band: amqp_bytes_t = @import("std").mem.zeroes(amqp_bytes_t),
};
pub const amqp_channel_open_t = struct_amqp_channel_open_t_;
pub const struct_amqp_channel_open_ok_t_ = extern struct {
    channel_id: amqp_bytes_t = @import("std").mem.zeroes(amqp_bytes_t),
};
pub const amqp_channel_open_ok_t = struct_amqp_channel_open_ok_t_;
pub const struct_amqp_channel_flow_t_ = extern struct {
    active: amqp_boolean_t = @import("std").mem.zeroes(amqp_boolean_t),
};
...
pub const struct_amqp_access_request_t_ = extern struct {
    realm: amqp_bytes_t = @import("std").mem.zeroes(amqp_bytes_t),
    exclusive: amqp_boolean_t = @import("std").mem.zeroes(amqp_boolean_t),
    passive: amqp_boolean_t = @import("std").mem.zeroes(amqp_boolean_t),
    active: amqp_boolean_t = @import("std").mem.zeroes(amqp_boolean_t),
    write: amqp_boolean_t = @import("std").mem.zeroes(amqp_boolean_t),
    read: amqp_boolean_t = @import("std").mem.zeroes(amqp_boolean_t),
};
pub const amqp_access_request_t = struct_amqp_access_request_t_;
pub const struct_amqp_access_request_ok_t_ = extern struct {
    ticket: u16 = @import("std").mem.zeroes(u16),
};
...
pub const struct_amqp_exchange_declare_t_ = extern struct {
    ticket: u16 = @import("std").mem.zeroes(u16),
    exchange: amqp_bytes_t = @import("std").mem.zeroes(amqp_bytes_t),
    type: amqp_bytes_t = @import("std").mem.zeroes(amqp_bytes_t),
    passive: amqp_boolean_t = @import("std").mem.zeroes(amqp_boolean_t),
    durable: amqp_boolean_t = @import("std").mem.zeroes(amqp_boolean_t),
    auto_delete: amqp_boolean_t = @import("std").mem.zeroes(amqp_boolean_t),
    internal: amqp_boolean_t = @import("std").mem.zeroes(amqp_boolean_t),
    nowait: amqp_boolean_t = @import("std").mem.zeroes(amqp_boolean_t),
    arguments: amqp_table_t = @import("std").mem.zeroes(amqp_table_t),
};
...
pub const struct_amqp_exchange_delete_t_ = extern struct {
    ticket: u16 = @import("std").mem.zeroes(u16),
    exchange: amqp_bytes_t = @import("std").mem.zeroes(amqp_bytes_t),
    if_unused: amqp_boolean_t = @import("std").mem.zeroes(amqp_boolean_t),
    nowait: amqp_boolean_t = @import("std").mem.zeroes(amqp_boolean_t),
};
...
pub const struct_amqp_exchange_bind_t_ = extern struct {
    ticket: u16 = @import("std").mem.zeroes(u16),
    destination: amqp_bytes_t = @import("std").mem.zeroes(amqp_bytes_t),
    source: amqp_bytes_t = @import("std").mem.zeroes(amqp_bytes_t),
    routing_key: amqp_bytes_t = @import("std").mem.zeroes(amqp_bytes_t),
    nowait: amqp_boolean_t = @import("std").mem.zeroes(amqp_boolean_t),
    arguments: amqp_table_t = @import("std").mem.zeroes(amqp_table_t),
};
...
pub const struct_amqp_queue_declare_t_ = extern struct {
    ticket: u16 = @import("std").mem.zeroes(u16),
    queue: amqp_bytes_t = @import("std").mem.zeroes(amqp_bytes_t),
    passive: amqp_boolean_t = @import("std").mem.zeroes(amqp_boolean_t),
    durable: amqp_boolean_t = @import("std").mem.zeroes(amqp_boolean_t),
    exclusive: amqp_boolean_t = @import("std").mem.zeroes(amqp_boolean_t),
    auto_delete: amqp_boolean_t = @import("std").mem.zeroes(amqp_boolean_t),
...
pub const struct_amqp_queue_declare_ok_t_ = extern struct {
    queue: amqp_bytes_t = @import("std").mem.zeroes(amqp_bytes_t),
    message_count: u32 = @import("std").mem.zeroes(u32),
    consumer_count: u32 = @import("std").mem.zeroes(u32),
};
...
pub const struct_amqp_queue_delete_t_ = extern struct {
    ...
    queue: amqp_bytes_t = @import("std").mem.zeroes(amqp_bytes_t),
    if_unused: amqp_boolean_t = @import("std").mem.zeroes(amqp_boolean_t),
    if_empty: amqp_boolean_t = @import("std").mem.zeroes(amqp_boolean_t),
    nowait: amqp_boolean_t = @import("std").mem.zeroes(amqp_boolean_t),
};
...
pub const struct_amqp_basic_qos_t_ = extern struct {
    prefetch_size: u32 = @import("std").mem.zeroes(u32),
    prefetch_count: u16 = @import("std").mem.zeroes(u16),
    global: amqp_boolean_t = @import("std").mem.zeroes(amqp_boolean_t),
};
...
pub const struct_amqp_basic_consume_t_ = extern struct {
    ticket: u16 = @import("std").mem.zeroes(u16),
    queue: amqp_bytes_t = @import("std").mem.zeroes(amqp_bytes_t),
    consumer_tag: amqp_bytes_t = @import("std").mem.zeroes(amqp_bytes_t),
    no_local: amqp_boolean_t = @import("std").mem.zeroes(amqp_boolean_t),
    no_ack: amqp_boolean_t = @import("std").mem.zeroes(amqp_boolean_t),
    exclusive: amqp_boolean_t = @import("std").mem.zeroes(amqp_boolean_t),
    nowait: amqp_boolean_t = @import("std").mem.zeroes(amqp_boolean_t),
    arguments: amqp_table_t = @import("std").mem.zeroes(amqp_table_t),
};
...
pub const struct_amqp_basic_publish_t_ = extern struct {
    ...
    exchange: amqp_bytes_t = @import("std").mem.zeroes(amqp_bytes_t),
    routing_key: amqp_bytes_t = @import("std").mem.zeroes(amqp_bytes_t),
    mandatory: amqp_boolean_t = @import("std").mem.zeroes(amqp_boolean_t),
    immediate: amqp_boolean_t = @import("std").mem.zeroes(amqp_boolean_t),
};
...
pub const struct_amqp_basic_deliver_t_ = extern struct {
    consumer_tag: amqp_bytes_t = @import("std").mem.zeroes(amqp_bytes_t),
    delivery_tag: u64 = @import("std").mem.zeroes(u64),
    redelivered: amqp_boolean_t = @import("std").mem.zeroes(amqp_boolean_t),
    exchange: amqp_bytes_t = @import("std").mem.zeroes(amqp_bytes_t),
    routing_key: amqp_bytes_t = @import("std").mem.zeroes(amqp_bytes_t),
};
...
pub const struct_amqp_connection_properties_t_ = extern struct {
    _flags: amqp_flags_t = @import("std").mem.zeroes(amqp_flags_t),
    dummy: u8 = @import("std").mem.zeroes(u8),
};
...
pub const struct_amqp_basic_properties_t_ = extern struct {
    _flags: amqp_flags_t = @import("std").mem.zeroes(amqp_flags_t),
    content_type: amqp_bytes_t = @import("std").mem.zeroes(amqp_bytes_t),
    content_encoding: amqp_bytes_t = @import("std").mem.zeroes(amqp_bytes_t),
    headers: amqp_table_t = @import("std").mem.zeroes(amqp_table_t),
    delivery_mode: u8 = @import("std").mem.zeroes(u8),
    priority: u8 = @import("std").mem.zeroes(u8),
    correlation_id: amqp_bytes_t = @import("std").mem.zeroes(amqp_bytes_t),
    reply_to: amqp_bytes_t = @import("std").mem.zeroes(amqp_bytes_t),
    expiration: amqp_bytes_t = @import("std").mem.zeroes(amqp_bytes_t),
    message_id: amqp_bytes_t = @import("std").mem.zeroes(amqp_bytes_t),
    timestamp: u64 = @import("std").mem.zeroes(u64),
    type: amqp_bytes_t = @import("std").mem.zeroes(amqp_bytes_t),
    user_id: amqp_bytes_t = @import("std").mem.zeroes(amqp_bytes_t),
    app_id: amqp_bytes_t = @import("std").mem.zeroes(amqp_bytes_t),
    cluster_id: amqp_bytes_t = @import("std").mem.zeroes(amqp_bytes_t),
};
...
pub extern fn amqp_basic_qos(state: amqp_connection_state_t, channel: amqp_channel_t, prefetch_size: u32, prefetch_count: u16, global: amqp_boolean_t) [*c]amqp_basic_qos_ok_t;
...
pub extern fn amqp_tune_connection(state: amqp_connection_state_t, channel_max: c_int, frame_max: c_int, heartbeat: c_int) c_int;
...
pub extern fn amqp_destroy_connection(state: amqp_connection_state_t) c_int;
...
pub extern fn amqp_send_frame(state: amqp_connection_state_t, frame: [*c]const amqp_frame_t) c_int;
pub extern fn amqp_table_entry_cmp(entry1: ?*const anyopaque, entry2: ?*const anyopaque) c_int;
pub extern fn amqp_open_socket(hostname: [*c]const u8, portnumber: c_int) c_int;
...
pub extern fn amqp_simple_wait_frame(state: amqp_connection_state_t, decoded_frame: [*c]amqp_frame_t) c_int;
pub extern fn amqp_simple_wait_frame_noblock(state: amqp_connection_state_t, decoded_frame: [*c]amqp_frame_t, tv: [*c]const struct_timeval) c_int;
pub extern fn amqp_simple_wait_method(state: amqp_connection_state_t, expected_channel: amqp_channel_t, expected_method: amqp_method_number_t, output: [*c]amqp_method_t) c_int;
pub extern fn amqp_send_method(state: amqp_connection_state_t, channel: amqp_channel_t, id: amqp_method_number_t, decoded: ?*anyopaque) c_int;
...
pub extern fn amqp_basic_publish(state: amqp_connection_state_t, channel: amqp_channel_t, exchange: amqp_bytes_t, routing_key: amqp_bytes_t, mandatory: amqp_boolean_t, immediate: amqp_boolean_t, properties: [*c]const struct_amqp_basic_properties_t_, body: amqp_bytes_t) c_int;
...
pub extern fn amqp_basic_ack(state: amqp_connection_state_t, channel: amqp_channel_t, delivery_tag: u64, multiple: amqp_boolean_t) c_int;
...
pub extern fn amqp_basic_reject(state: amqp_connection_state_t, channel: amqp_channel_t, delivery_tag: u64, requeue: amqp_boolean_t) c_int;
pub extern fn amqp_basic_nack(state: amqp_connection_state_t, channel: amqp_channel_t, delivery_tag: u64, multiple: amqp_boolean_t, requeue: amqp_boolean_t) c_int;
...
pub extern fn amqp_decode_table(encoded: amqp_bytes_t, pool: [*c]amqp_pool_t, output: [*c]amqp_table_t, offset: [*c]usize) c_int;
pub extern fn amqp_encode_table(encoded: amqp_bytes_t, input: [*c]amqp_table_t, offset: [*c]usize) c_int;
pub extern fn amqp_table_clone(original: [*c]const amqp_table_t, clone: [*c]amqp_table_t, pool: [*c]amqp_pool_t) c_int;
pub const struct_amqp_message_t_ = extern struct {
    properties: amqp_basic_properties_t = @import("std").mem.zeroes(amqp_basic_properties_t),
    body: amqp_bytes_t = @import("std").mem.zeroes(amqp_bytes_t),
    pool: amqp_pool_t = @import("std").mem.zeroes(amqp_pool_t),
};
...
pub const struct_amqp_envelope_t_ = extern struct {
    channel: amqp_channel_t = @import("std").mem.zeroes(amqp_channel_t),
    consumer_tag: amqp_bytes_t = @import("std").mem.zeroes(amqp_bytes_t),
    delivery_tag: u64 = @import("std").mem.zeroes(u64),
    redelivered: amqp_boolean_t = @import("std").mem.zeroes(amqp_boolean_t),
    exchange: amqp_bytes_t = @import("std").mem.zeroes(amqp_bytes_t),
    routing_key: amqp_bytes_t = @import("std").mem.zeroes(amqp_bytes_t),
    message: amqp_message_t = @import("std").mem.zeroes(amqp_message_t),
};
pub const amqp_envelope_t = struct_amqp_envelope_t_;
pub extern fn amqp_consume_message(state: amqp_connection_state_t, envelope: [*c]amqp_envelope_t, timeout: [*c]const struct_timeval, flags: c_int) amqp_rpc_reply_t;
...
pub const struct_amqp_connection_info = extern struct {
    ...
    vhost: [*c]u8 = @import("std").mem.zeroes([*c]u8),
    port: c_int = @import("std").mem.zeroes(c_int),
    ssl: amqp_boolean_t = @import("std").mem.zeroes(amqp_boolean_t),
};
...
pub extern fn amqp_socket_open(self: ?*amqp_socket_t, host: [*c]const u8, port: c_int) c_int;
pub extern fn amqp_socket_open_noblock(self: ?*amqp_socket_t, host: [*c]const u8, port: c_int, timeout: [*c]const struct_timeval) c_int;
...
pub extern fn amqp_get_handshake_timeout(state: amqp_connection_state_t) [*c]struct_timeval;
pub extern fn amqp_set_handshake_timeout(state: amqp_connection_state_t, timeout: [*c]const struct_timeval) c_int;
pub extern fn amqp_get_rpc_timeout(state: amqp_connection_state_t) [*c]struct_timeval;
pub extern fn amqp_set_rpc_timeout(state: amqp_connection_state_t, timeout: [*c]const struct_timeval) c_int;
...
pub extern fn die(fmt: [*c]const u8, ...) void;
pub extern fn die_on_error(x: c_int, context: [*c]const u8) void;
pub extern fn die_on_amqp_error(x: amqp_rpc_reply_t, context: [*c]const u8) void;
pub extern fn amqp_dump(buffer: ?*const anyopaque, len: usize) void;
pub extern fn now_microseconds() u64;
pub extern fn microsleep(usec: c_int) void;
pub export fn main(arg_argc: c_int, arg_argv: [*c]const [*c]const u8) c_int {
    var argc = arg_argc;
    _ = &argc;
    var argv = arg_argv;
    _ = &argv;
    var hostname: [*c]const u8 = undefined;
    _ = &hostname;
    var port: c_int = undefined;
    _ = &port;
    var status: c_int = undefined;
    _ = &status;
    var exchange: [*c]const u8 = undefined;
    _ = &exchange;
    var bindingkey: [*c]const u8 = undefined;
    _ = &bindingkey;
    var queue: [*c]const u8 = undefined;
    _ = &queue;
    var socket: ?*amqp_socket_t = null;
    _ = &socket;
    var conn: amqp_connection_state_t = undefined;
    _ = &conn;
    if (argc < @as(c_int, 6)) {
        _ = fprintf(__stderrp, "Usage: amqp_bind host port exchange bindingkey queue\n");
        return 1;
    }
    hostname = argv[@as(c_uint, @intCast(@as(c_int, 1)))];
    port = atoi(argv[@as(c_uint, @intCast(@as(c_int, 2)))]);
    exchange = argv[@as(c_uint, @intCast(@as(c_int, 3)))];
    bindingkey = argv[@as(c_uint, @intCast(@as(c_int, 4)))];
    queue = argv[@as(c_uint, @intCast(@as(c_int, 5)))];
    ...
    die_on_amqp_error(amqp_login(conn, "/", @as(c_int, 0), @as(c_int, 131072), @as(c_int, 0), AMQP_SASL_METHOD_PLAIN, "guest", "guest"), "Logging in");
    _ = amqp_channel_open(conn, @as(amqp_channel_t, @bitCast(@as(c_short, @truncate(@as(c_int, 1))))));
    die_on_amqp_error(amqp_get_rpc_reply(conn), "Opening channel");
    _ = amqp_queue_bind(conn, @as(amqp_channel_t, @bitCast(@as(c_short, @truncate(@as(c_int, 1))))), amqp_cstring_bytes(queue), amqp_cstring_bytes(exchange), amqp_cstring_bytes(bindingkey), amqp_empty_table);
    die_on_amqp_error(amqp_get_rpc_reply(conn), "Unbinding");
    die_on_amqp_error(amqp_channel_close(conn, @as(amqp_channel_t, @bitCast(@as(c_short, @truncate(@as(c_int, 1))))), @as(c_int, 200)), "Closing channel");
    die_on_amqp_error(amqp_connection_close(conn, @as(c_int, 200)), "Closing connection");
...
pub const AMQP_EXPORT = @compileError("unable to translate macro: undefined identifier `visibility`");
// /opt/homebrew/Cellar/rabbitmq-c/0.14.0/include/rabbitmq-c/export.h:15:15
pub const AMQP_NO_EXPORT = @compileError("unable to translate macro: undefined identifier `visibility`");
// /opt/homebrew/Cellar/rabbitmq-c/0.14.0/include/rabbitmq-c/export.h:20:13
pub const AMQP_DEPRECATED = @compileError("unable to translate macro: undefined identifier `__deprecated__`");
// /opt/homebrew/Cellar/rabbitmq-c/0.14.0/include/rabbitmq-c/export.h:25:11
pub const AMQP_DEPRECATED_EXPORT = AMQP_EXPORT ++ AMQP_DEPRECATED;
pub const AMQP_DEPRECATED_NO_EXPORT = AMQP_NO_EXPORT ++ AMQP_DEPRECATED;
...
pub const AMQP_VERSION_MINOR = @as(c_int, 14);
...
// /opt/homebrew/Cellar/rabbitmq-c/0.14.0/include/rabbitmq-c/amqp.h:163:9
...
pub const AMQP_DEFAULT_FRAME_SIZE = @import("std").zig.c_translation.promoteIntLiteral(c_int, 131072, .decimal);
...
pub const AMQP_CONNECTION_START_METHOD = @import("std").zig.c_translation.cast(amqp_method_number_t, @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x000A000A, .hex));
pub const AMQP_CONNECTION_START_OK_METHOD = @import("std").zig.c_translation.cast(amqp_method_number_t, @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x000A000B, .hex));
pub const AMQP_CONNECTION_SECURE_METHOD = @import("std").zig.c_translation.cast(amqp_method_number_t, @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x000A0014, .hex));
pub const AMQP_CONNECTION_SECURE_OK_METHOD = @import("std").zig.c_translation.cast(amqp_method_number_t, @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x000A0015, .hex));
pub const AMQP_CONNECTION_TUNE_METHOD = @import("std").zig.c_translation.cast(amqp_method_number_t, @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x000A001E, .hex));
pub const AMQP_CONNECTION_TUNE_OK_METHOD = @import("std").zig.c_translation.cast(amqp_method_number_t, @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x000A001F, .hex));
pub const AMQP_CONNECTION_OPEN_METHOD = @import("std").zig.c_translation.cast(amqp_method_number_t, @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x000A0028, .hex));
pub const AMQP_CONNECTION_OPEN_OK_METHOD = @import("std").zig.c_translation.cast(amqp_method_number_t, @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x000A0029, .hex));
pub const AMQP_CONNECTION_CLOSE_METHOD = @import("std").zig.c_translation.cast(amqp_method_number_t, @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x000A0032, .hex));
pub const AMQP_CONNECTION_CLOSE_OK_METHOD = @import("std").zig.c_translation.cast(amqp_method_number_t, @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x000A0033, .hex));
pub const AMQP_CONNECTION_BLOCKED_METHOD = @import("std").zig.c_translation.cast(amqp_method_number_t, @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x000A003C, .hex));
pub const AMQP_CONNECTION_UNBLOCKED_METHOD = @import("std").zig.c_translation.cast(amqp_method_number_t, @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x000A003D, .hex));
pub const AMQP_CONNECTION_UPDATE_SECRET_METHOD = @import("std").zig.c_translation.cast(amqp_method_number_t, @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x000A0046, .hex));
pub const AMQP_CONNECTION_UPDATE_SECRET_OK_METHOD = @import("std").zig.c_translation.cast(amqp_method_number_t, @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x000A0047, .hex));
pub const AMQP_CHANNEL_OPEN_METHOD = @import("std").zig.c_translation.cast(amqp_method_number_t, @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x0014000A, .hex));
pub const AMQP_CHANNEL_OPEN_OK_METHOD = @import("std").zig.c_translation.cast(amqp_method_number_t, @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x0014000B, .hex));
pub const AMQP_CHANNEL_FLOW_METHOD = @import("std").zig.c_translation.cast(amqp_method_number_t, @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x00140014, .hex));
pub const AMQP_CHANNEL_FLOW_OK_METHOD = @import("std").zig.c_translation.cast(amqp_method_number_t, @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x00140015, .hex));
pub const AMQP_CHANNEL_CLOSE_METHOD = @import("std").zig.c_translation.cast(amqp_method_number_t, @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x00140028, .hex));
pub const AMQP_CHANNEL_CLOSE_OK_METHOD = @import("std").zig.c_translation.cast(amqp_method_number_t, @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x00140029, .hex));
pub const AMQP_ACCESS_REQUEST_METHOD = @import("std").zig.c_translation.cast(amqp_method_number_t, @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x001E000A, .hex));
pub const AMQP_ACCESS_REQUEST_OK_METHOD = @import("std").zig.c_translation.cast(amqp_method_number_t, @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x001E000B, .hex));
pub const AMQP_EXCHANGE_DECLARE_METHOD = @import("std").zig.c_translation.cast(amqp_method_number_t, @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x0028000A, .hex));
pub const AMQP_EXCHANGE_DECLARE_OK_METHOD = @import("std").zig.c_translation.cast(amqp_method_number_t, @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x0028000B, .hex));
pub const AMQP_EXCHANGE_DELETE_METHOD = @import("std").zig.c_translation.cast(amqp_method_number_t, @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x00280014, .hex));
pub const AMQP_EXCHANGE_DELETE_OK_METHOD = @import("std").zig.c_translation.cast(amqp_method_number_t, @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x00280015, .hex));
pub const AMQP_EXCHANGE_BIND_METHOD = @import("std").zig.c_translation.cast(amqp_method_number_t, @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x0028001E, .hex));
pub const AMQP_EXCHANGE_BIND_OK_METHOD = @import("std").zig.c_translation.cast(amqp_method_number_t, @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x0028001F, .hex));
pub const AMQP_EXCHANGE_UNBIND_METHOD = @import("std").zig.c_translation.cast(amqp_method_number_t, @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x00280028, .hex));
pub const AMQP_EXCHANGE_UNBIND_OK_METHOD = @import("std").zig.c_translation.cast(amqp_method_number_t, @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x00280033, .hex));
pub const AMQP_QUEUE_DECLARE_METHOD = @import("std").zig.c_translation.cast(amqp_method_number_t, @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x0032000A, .hex));
pub const AMQP_QUEUE_DECLARE_OK_METHOD = @import("std").zig.c_translation.cast(amqp_method_number_t, @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x0032000B, .hex));
pub const AMQP_QUEUE_BIND_METHOD = @import("std").zig.c_translation.cast(amqp_method_number_t, @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x00320014, .hex));
pub const AMQP_QUEUE_BIND_OK_METHOD = @import("std").zig.c_translation.cast(amqp_method_number_t, @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x00320015, .hex));
pub const AMQP_QUEUE_PURGE_METHOD = @import("std").zig.c_translation.cast(amqp_method_number_t, @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x0032001E, .hex));
pub const AMQP_QUEUE_PURGE_OK_METHOD = @import("std").zig.c_translation.cast(amqp_method_number_t, @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x0032001F, .hex));
pub const AMQP_QUEUE_DELETE_METHOD = @import("std").zig.c_translation.cast(amqp_method_number_t, @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x00320028, .hex));
pub const AMQP_QUEUE_DELETE_OK_METHOD = @import("std").zig.c_translation.cast(amqp_method_number_t, @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x00320029, .hex));
pub const AMQP_QUEUE_UNBIND_METHOD = @import("std").zig.c_translation.cast(amqp_method_number_t, @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x00320032, .hex));
pub const AMQP_QUEUE_UNBIND_OK_METHOD = @import("std").zig.c_translation.cast(amqp_method_number_t, @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x00320033, .hex));
pub const AMQP_BASIC_QOS_METHOD = @import("std").zig.c_translation.cast(amqp_method_number_t, @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x003C000A, .hex));
pub const AMQP_BASIC_QOS_OK_METHOD = @import("std").zig.c_translation.cast(amqp_method_number_t, @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x003C000B, .hex));
pub const AMQP_BASIC_CONSUME_METHOD = @import("std").zig.c_translation.cast(amqp_method_number_t, @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x003C0014, .hex));
pub const AMQP_BASIC_CONSUME_OK_METHOD = @import("std").zig.c_translation.cast(amqp_method_number_t, @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x003C0015, .hex));
pub const AMQP_BASIC_CANCEL_METHOD = @import("std").zig.c_translation.cast(amqp_method_number_t, @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x003C001E, .hex));
pub const AMQP_BASIC_CANCEL_OK_METHOD = @import("std").zig.c_translation.cast(amqp_method_number_t, @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x003C001F, .hex));
pub const AMQP_BASIC_PUBLISH_METHOD = @import("std").zig.c_translation.cast(amqp_method_number_t, @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x003C0028, .hex));
pub const AMQP_BASIC_RETURN_METHOD = @import("std").zig.c_translation.cast(amqp_method_number_t, @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x003C0032, .hex));
pub const AMQP_BASIC_DELIVER_METHOD = @import("std").zig.c_translation.cast(amqp_method_number_t, @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x003C003C, .hex));
pub const AMQP_BASIC_GET_METHOD = @import("std").zig.c_translation.cast(amqp_method_number_t, @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x003C0046, .hex));
pub const AMQP_BASIC_GET_OK_METHOD = @import("std").zig.c_translation.cast(amqp_method_number_t, @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x003C0047, .hex));
pub const AMQP_BASIC_GET_EMPTY_METHOD = @import("std").zig.c_translation.cast(amqp_method_number_t, @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x003C0048, .hex));
pub const AMQP_BASIC_ACK_METHOD = @import("std").zig.c_translation.cast(amqp_method_number_t, @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x003C0050, .hex));
pub const AMQP_BASIC_REJECT_METHOD = @import("std").zig.c_translation.cast(amqp_method_number_t, @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x003C005A, .hex));
pub const AMQP_BASIC_RECOVER_ASYNC_METHOD = @import("std").zig.c_translation.cast(amqp_method_number_t, @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x003C0064, .hex));
pub const AMQP_BASIC_RECOVER_METHOD = @import("std").zig.c_translation.cast(amqp_method_number_t, @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x003C006E, .hex));
pub const AMQP_BASIC_RECOVER_OK_METHOD = @import("std").zig.c_translation.cast(amqp_method_number_t, @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x003C006F, .hex));
pub const AMQP_BASIC_NACK_METHOD = @import("std").zig.c_translation.cast(amqp_method_number_t, @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x003C0078, .hex));
pub const AMQP_TX_SELECT_METHOD = @import("std").zig.c_translation.cast(amqp_method_number_t, @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x005A000A, .hex));
pub const AMQP_TX_SELECT_OK_METHOD = @import("std").zig.c_translation.cast(amqp_method_number_t, @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x005A000B, .hex));
pub const AMQP_TX_COMMIT_METHOD = @import("std").zig.c_translation.cast(amqp_method_number_t, @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x005A0014, .hex));
pub const AMQP_TX_COMMIT_OK_METHOD = @import("std").zig.c_translation.cast(amqp_method_number_t, @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x005A0015, .hex));
pub const AMQP_TX_ROLLBACK_METHOD = @import("std").zig.c_translation.cast(amqp_method_number_t, @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x005A001E, .hex));
pub const AMQP_TX_ROLLBACK_OK_METHOD = @import("std").zig.c_translation.cast(amqp_method_number_t, @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x005A001F, .hex));
pub const AMQP_CONFIRM_SELECT_METHOD = @import("std").zig.c_translation.cast(amqp_method_number_t, @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x0055000A, .hex));
pub const AMQP_CONFIRM_SELECT_OK_METHOD = @import("std").zig.c_translation.cast(amqp_method_number_t, @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x0055000B, .hex));
...
pub const RABBITMQ_C_TCP_SOCKET_H = "";
pub const librabbitmq_examples_utils_h = "";
